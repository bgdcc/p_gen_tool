...
A command-line password manager using GPG encryption for secure local storage. This is a project done strictly for educational purposes, and should not be used for personal password storage. All passwords and/or email addresses which may appear in this document are utilized only for demonstration purposes and have no real usage.
